...
class LeavesApprovalPendingAdapter(private val dataList: List<LeavesApproval>)
    : RecyclerView.Adapter<LeavesApprovalPendingAdapter.LeavesApprovalPendingViewHolder>(){
    class LeavesApprovalPendingViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onBindViewHolder(holder: LeavesApprovalPendingViewHolder, position: Int) {
